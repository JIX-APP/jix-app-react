...
import { X, Mail, Smartphone, ArrowLeft, ShieldCheck, Loader2 } from 'lucide-react';
...
export const JixAuthModal: React.FC<JixAuthModalProps> = ({ isOpen, onClose, onSuccessLogin }) => {
  ...
  // خطوة 1: إرسال كود الـ OTP عبر Supabase (بيستخدم إعدادات Brevo SMTP + قالب Confirm sign up مع {{ .Token }})
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
      <div className="relative w-full max-w-md bg-[#0f1118] border border-amber-500/30 rounded-3xl p-6 text-white shadow-2xl shadow-amber-500/10">
